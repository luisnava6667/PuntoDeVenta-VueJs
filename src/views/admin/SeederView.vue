    ...
    <div class="mt-10">
        ...
        <div class="flex justify-center bg-white shadow">
            <div class="mx-auto mt-10 p-10 w-full  2xl:w-2/4">
                <FormKit type="form" submit-label="Agregar Imágenes"
                ...
                <div class="mt-16">
                    <FormKit type="form" submit-label="Agregar Productos"
                        incomplete-message="No se pudo enviar, revisa los mensajes" @submit="seedDB">
                    </FormKit>
                </div>
            </div>
        </div>
